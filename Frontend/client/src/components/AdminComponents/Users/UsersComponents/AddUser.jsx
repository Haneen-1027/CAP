    ...
    <>
      ...
      <form onSubmit={onSubmit}>
        <div className={`card ${darkMode ? "spic-dark-mode" : ""} my-4`}>
          <div className={`card-header d-flex flex-column flex-md-row justify-content-between align-items-center p-4 ${darkMode ? "spic-dark-mode" : ""}`}>
            <h1 className="h5 text-center mb-0"><strong>Add User:</strong></h1>
          </div>

          {/* Name Section */}
          <div className={`card-header d-flex flex-column flex-md-row justify-content-between align-items-center p-3 ${darkMode ? "spic-dark-mode" : ""}`}>
            <div className="col-12 col-md-5 row m-0 justify-content-between">
              <div className="col-12 col-md-5 form-floating p-0">
                <input
                  type="text"
                  className={`form-control ${errors.firstName ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                  id="firstName"
                  name="firstName"
              ...
              <div className="col-12 col-md-5 form-floating my-2 m-md-0 p-0">
                <input
                  type="text"
                  className={`form-control ${errors.lastName ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                  id="lastName"
                  name="lastName"
            ...
            <div className="col-12 col-md-5 form-floating">
              <input
                type="text"
                className={`form-control ${errors.username ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                id="username"
                name="username"
          ...
          <div className={`card-header d-flex flex-column flex-md-row justify-content-between align-items-center p-3 ${darkMode ? "spic-dark-mode" : ""}`}>
            <div className="col-12 col-md-5 form-floating p-0">
              <input
                type="email"
                className={`form-control ${errors.email ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                id="email"
                name="email"
                placeholder="Email"
                value={user.email}
            ...
            <div className="col-12 col-md-5 row m-0 justify-content-between">
              <div className="col-12 col-md-5 form-floating p-0 my-2 m-md-0">
                <input
                  type="date"
                  className={`form-control ${errors.dateOfBirth ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode text-light" : ""}`}
                  id="dateOfBirth"
                  name="dateOfBirth"
          ...
          <div className={`card-header d-flex flex-column flex-md-row justify-content-between align-items-center p-3 ${darkMode ? "spic-dark-mode" : ""}`}>
            <div className="col-12 col-md-5 form-floating p-0 position-relative">
              <input
                ...
                className={`form-control ${errors.password ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                id="password"
                name="password"
            ...
            <div className="col-12 col-md-5 form-floating p-0 my-2 m-md-0">
              <input
                type={showPassword ? "text" : "password"}
                className={`form-control ${errors.confirmPassword ? "is-invalid" : ""} ${darkMode ? "spic-dark-mode" : ""}`}
                id="confirmPassword"

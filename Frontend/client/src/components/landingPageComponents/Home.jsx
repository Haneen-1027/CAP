...
export default function Home({darkMode}) {
  return (
    <div className={`container-fluid bg-light min-vh-100 d-flex align-items-center ${darkMode ? "spic-dark-mode text-white" : ""}`}>
      <div className="container text-center">
        {/* Header Section */}
        <h1 className="display-4 fw-bold">Welcome to Code Execution Platform</h1>
        <p className={`lead ${darkMode ? "text-white":"text-muted"}`}>
          Test your coding skills, run code instantly, and take coding assessments with ease.
        </p>
        ...
        <div className="mt-4">
          ...
          <Link to="/signup" className="btn btn-outline-primary btn-lg mx-2">
            Sign Up
          </Link>
        </div>
        ...
        <div className="row mt-5">
          <div className="col-md-4">
            <div className={`card shadow-sm p-4 ${darkMode ? "dark-theme text-white":""}`}>
        ...
        <footer className={`mt-5 ${darkMode ? "text-white":"text-muted"}`}>
          <p>&copy; {new Date().getFullYear()} Code Execution Platform. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
